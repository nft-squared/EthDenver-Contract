import {GetContractTypeFromFactory, GetARGsTypeFromFactory} from "../typechain/common";
//const { ethers, upgrades } = hre;
import { Signer, Contract} from "ethers";
import fs from 'fs';
const record = require('./record');

type ContractT<T extends {new(...args:any[]):any}> = GetContractTypeFromFactory<InstanceType<T>>
type InitParams<T> = T extends {initialize(...args:infer P):any} ? P : never
type DeployParams<T extends {new(...args:any[]):any}> =  GetARGsTypeFromFactory<InstanceType<T>>
